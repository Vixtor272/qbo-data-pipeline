...
def load_data_from_api(*args, **kwargs):
    """
    Extrae información de Items de QuickBooks y filtra por fecha usando
    ...
    while True:
        ...
        logging.info(f'Página {page_number}: {len(items)} registros descargados.')
        print(f'Página {page_number}: {len(items)} registros descargados.')
